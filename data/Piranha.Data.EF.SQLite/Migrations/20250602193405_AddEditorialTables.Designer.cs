...
namespace Piranha.Data.EF.SQLite.Migrations
{
    ...
    [Migration("20250602193405_AddEditorialTables")]
    partial class AddEditorialTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Piranha.Editorial.Abstractions.Models.ContentStateHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Piranha.Editorial.Abstractions.Models.PageEditorialStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("PageEditorialStatuses");
                });

            modelBuilder.Entity("Piranha.Editorial.Abstractions.Models.Workflow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Piranha.Editorial.Abstractions.Models.WorkflowStage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Piranha.Editorial.Abstractions.Models.WorkflowTransition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Piranha.Editorial.Abstractions.Models.PageEditorialStatus", b =>
                {
                    b.HasOne("Piranha.Editorial.Abstractions.Models.WorkflowStage", "CurrentStage")
                        .WithMany()
            ...
            modelBuilder.Entity("Piranha.Editorial.Abstractions.Models.WorkflowStage", b =>
                {
                    b.HasOne("Piranha.Editorial.Abstractions.Models.Workflow", null)
                        .WithMany("Stages")
