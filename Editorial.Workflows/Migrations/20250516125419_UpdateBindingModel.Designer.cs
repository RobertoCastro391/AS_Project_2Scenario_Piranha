...
namespace Editorial.Workflows.Migrations
{
    ...
    [Migration("20250516125419_UpdateBindingModel")]
    partial class UpdateBindingModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Editorial.Workflows.Models.ContentWorkflowBinding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Editorial.Workflows.Models.ContentWorkflowBinding", b =>
                {
                    b.HasOne("Editorial.Workflows.Models.WorkflowStage", "CurrentStage")
                        .WithMany()
                        .HasForeignKey("CurrentStageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Editorial.Workflows.Models.Workflow", "Workflow")
                        .WithMany()
